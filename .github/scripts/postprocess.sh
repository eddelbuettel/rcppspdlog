...
sed -i -e's/Changes in RcppSpdlog version/Version/g' docs/NEWS/index.html
...
sed -i -e's/\[\(\#[0-9]\+\)\](https:\/\/github\.com\/eddelbuettel\/rcppspdlog\/[a-z]\+\/[0-9]\+)/\1/g' docs/NEWS/index.html
